...
class Car(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.original_image = pygame.image.load(os.path.join("carr.png"))
    ...
    def collision(self):
        length = 40
        collision_point_right = [int(self.rect.center[0] + math.cos(math.radians(self.angle + 10)) * length),
                                 int(self.rect.center[1] - math.sin(math.radians(self.angle + 10)) * length)]
        collision_point_left = [int(self.rect.center[0] + math.cos(math.radians(self.angle - 10)) * length),
                                 int(self.rect.center[1] - math.sin(math.radians(self.angle - 10)) * length)]
